...
CKEDITOR.plugins.setLang("a11yhelp", "ku", {
    title: "ڕێنمای لەبەردەستدابوون", contents: "پێکهاتەی یارمەتی. کلیك ESC بۆ داخستنی ئەم دیالۆگه.", legend: [{
        name: "گشتی",
        items: [{
        ...
        {
            name: "فه‌رمانه‌کان",
            items: [{name: "فه‌رمانی پووچکردنه‌وه", legend: "کلیك ${undo}"}, {
                name: "فه‌رمانی هه‌ڵگه‌ڕانه‌وه",
                legend: "کلیك ${redo}"
            }, {name: "فه‌رمانی ده‌قی قه‌ڵه‌و", legend: "کلیك ${bold}"}, {
                name: "فه‌رمانی ده‌قی لار",
                legend: "کلیك ${italic}"
            }, {name: "فه‌رمانی ژێرهێڵ", legend: "کلیك ${underline}"}, {
                ...
                }, {name: "ده‌ستپێگه‌یشتنی یارمه‌تی", legend: "کلیك ${a11yHelp}"}]
        }]
});